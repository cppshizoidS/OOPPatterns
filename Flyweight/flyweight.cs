...
class PanelHouse : House
{
    ...
    {
        Console.WriteLine("A panel house of 16 floors was built; coordinates: {0} latitude and {1} longitude",
            latitude, longitude);
    }
}
class BrickHouse : House
{
    ...
    public override void Build(double longitude, double latitude)
    {
        Console.WriteLine("Built a brick house of 5 floors; coordinates: {0} latitude and {1} longitude",
            latitude, longitude);
    }
}
